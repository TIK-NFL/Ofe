...
Ofe.Browser.WebKit419 = Ofe.Browser.WebKit && (Prototype.BrowserFeatures.XPath)
Ofe.Browser.WebKit420 = Ofe.Browser.WebKit && (!Prototype.BrowserFeatures.XPath)
...
Ofe.Browser.switch = function(p1,p2) {
  if(Ofe.Browser.Gecko) {
    if(parseFloat(navigator.userAgent.match("rv:(\\d+\.\\d+)")[1]) < 1.9) {
      return p1
    }
    else {
      return p2
...
Ofe.Matheval = {
  ...
  init : function(node,str) {
    ...
    img.src  = "Services/Ofe/images/ofe_gumdrop.png";
    ...
    if (Ofe.Matheval.isEval()) {
      ...
      //  Ofe.start('http://ofe:3000/ofe?math='+encodeURIComponent(str.replace(/\s+/g," ")));
      //  },true);
